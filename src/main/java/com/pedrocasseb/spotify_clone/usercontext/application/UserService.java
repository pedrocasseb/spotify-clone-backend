package com.pedrocasseb.spotify_clone.usercontext.application;

import com.pedrocasseb.spotify_clone.usercontext.ReadUserDTO;
import com.pedrocasseb.spotify_clone.usercontext.domain.User;
import com.pedrocasseb.spotify_clone.usercontext.mapper.UserMapper;
import com.pedrocasseb.spotify_clone.usercontext.repository.UserRepository;
...
public class UserService {
    ...
    private User mapOauth2AttributesToUser(Map<String, Object> attributes) {
        ...
        if(attributes.get("preffered_username") != null ) {
